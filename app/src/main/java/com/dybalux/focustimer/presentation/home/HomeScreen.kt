package com.dybalux.focustimer.presentation.home
...
import com.dybalux.focustimer.domain.model.TimerTypeEnum
import com.dybalux.focustimer.presentation.components.AutoResizedText
import com.dybalux.focustimer.presentation.components.BorderedIcon
import com.dybalux.focustimer.presentation.components.CircleDot
import com.dybalux.focustimer.presentation.components.CustomButton
import com.dybalux.focustimer.presentation.components.InformationItem
import com.dybalux.focustimer.presentation.components.TimerTypeItem
...
fun HomeScreen(viewModel: HomeScreenViewModel = HomeScreenViewModel()) {
    val timeState by remember {
        mutableStateOf(viewModel.timerValueState)
    }
    val timerTypeState by remember {
        mutableStateOf(viewModel.timerTypeState)
    }
    val roundsState by remember {
        mutableStateOf(viewModel.roundsState)
    }
    val todayTimeState by remember {
        mutableStateOf(viewModel.todayTimeState)
    }
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        Spacer(modifier = Modifier.height(FocusTimerTheme.dimens.spacerMedium))
        TimerSession(timer = viewModel.millisToMinutes(timeState.value), onIncreaseTap = {
...
fun TimerSession(
    ...
    Row(
        ...
        Column(
            ...
            Spacer(modifier = Modifier.height(FocusTimerTheme.dimens.spacerNormal))
        }
        AutoResizedText(
            text = timer,
            modifier = Modifier
